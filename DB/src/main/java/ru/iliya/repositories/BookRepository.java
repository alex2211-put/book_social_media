...
public interface BookRepository extends JpaRepository<Book, Integer> {
    ...
    List <Book> findBooksByTitleLikeAndAuthorsAndGenre(String title, List <Author> authors, String genre);

    List <Book> findBooksByTitleAndAuthorsAndGenre(String title, List <Author> authors, String genre);

    List <Book> findBooksByTitleLikeAndAuthors(String title, List <Author> authors);

    List <Book> findBooksByTitleAndAuthors(String title, List <Author> authors);

    List <Book> findBooksByTitleLikeAndGenre(String title, String genre);
